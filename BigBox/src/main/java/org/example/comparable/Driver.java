...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        Apple apple1 = new Apple(Size.LARGE, Color.GREEN, "Granny Smity");
        ...
        Orange orange2 = new Orange(Size.LARGE);
        Orange orange3 = new Orange(Size.MEDIUM);
        Orange orange4 = new Orange(Size.SMALL);
